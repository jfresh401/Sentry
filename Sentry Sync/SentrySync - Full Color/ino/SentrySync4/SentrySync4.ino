...
void setup() {
  ...
  tft.initR(INITR_MINI160x80);  // Initialize the display with a black tab (common for ST7735)
  tft.setRotation(ST7735_MADCTL_BGR);
  tft.invertDisplay(1);
  tft.fillScreen(ST7735_BLACK);  // Clear the screen with black
  tft.setTextSize(1);            // Set default text size
  tft.setTextColor(ST7735_WHITE); // Set default text color to white
...
//----------------------------------------------------------------------------------
void drawBackground() {
  tft.drawRGBBitmap(0, 0, JFresh_AI_128x64, 160, 80);  // Draw the background image
}
//----------------------------------------------------------------------------------
...
void updateOLED() {
  ...
  tft.setCursor(0, 10);
  tft.print("GPU: ");
  tft.print(gpuTemp, 1); // Display GPU temperature with 1 decimal place
  tft.print("C");
  tft.println();
  tft.print("CPU: ");
  tft.print(cpuTemp, 1); // Display CPU temperature with 1 decimal place
  tft.print("C");
  tft.println();
  tft.print("EDR: ");
  tft.print(memTemp, 1); // Display MEM temperature with 1 decimal place
  tft.print("C");
  tft.println();
  tft.print(" MB: ");
  tft.print(caseTemp, 1); // Display Case temperature with 1 decimal place
  tft.print("C");
  tft.println();
