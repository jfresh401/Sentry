...
// Display splash screen
  tft.drawBitmap(20, 10, epd_bitmap_sentrysplash, 128, 64, XBGreen);
  tft.setTextSize(3);
  tft.setTextColor(TFT_WHITE);
  ...
  if (!sdStatus) {
    ...
    tft.drawBitmap(40, 50, epd_bitmap_question, 128, 64, CoolBlue); // SD Card Image
    tft.setTextSize(2); // Set text size
    tft.setTextColor(xYellow, xRed); // Set text color
    tft.setCursor(20, 10); // Set cursor position
